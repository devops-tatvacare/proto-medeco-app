...
import { usePathwayBuilder, Assessment } from '@/context/PathwayBuilderContext';

export function PathwayBuilderAssessment() {
  const { assessments, updateAssessment, advanceStep } = usePathwayBuilder();
  const anySelected = assessments.some(a => a.selected);
        ...
        {assessments.map((assessment) => (
          ...
          >
            <input
              ...
              onChange={(e) => updateAssessment(assessment.id, e.target.checked)}
