...
interface PathwayBuilderStageProps {
  stageName: string;
...
export function PathwayBuilderStage({
  stageName,
  stageDescription,
  stageIcon,
  currentStage,
  totalStages,
  children
}: PathwayBuilderStageProps) {
  const { pathwayName, goBackStep } = usePathwayBuilder();
