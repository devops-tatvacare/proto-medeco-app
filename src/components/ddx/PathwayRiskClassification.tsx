...
interface PathwayRiskClassificationProps {
  riskLevel: 'standard' | 'high' | 'complex' | null;
  onSelectRisk: (level: 'standard' | 'high' | 'complex') => void;
  onContinue: () => void;
}

export function PathwayRiskClassification({ riskLevel, onSelectRisk, onContinue }: PathwayRiskClassificationProps) {
  const riskOptions = [
    {
      value: 'standard' as const,
      label: 'Standard Risk',
      description: 'NYHA Class I-II - Minimal symptoms, good functional capacity',
      indicator: '#10b981'
    },
    {
      value: 'high' as const,
      label: 'High Risk',
      description: 'NYHA Class III - Marked limitation, symptoms with minimal activity',
      indicator: '#f59e0b'
    },
    {
      value: 'complex' as const,
      label: 'Complex/Comorbid',
      description: 'NYHA Class IV - Severe limitations, symptoms at rest',
      indicator: '#ef4444'
    }
  ];
